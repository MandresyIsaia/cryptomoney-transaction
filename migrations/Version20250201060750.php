 ...
 */
final class Version20250201060750 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tablecrypto (id INT DEFAULT tablecrypto_id_seq NOT NULL, id_crypto INT DEFAULT NULL, court DOUBLE PRECISION DEFAULT \'0\', daty DATE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE transaction (id INT DEFAULT transaction_id_seq NOT NULL, id_user INT DEFAULT NULL, id_crypto INT DEFAULT NULL, quantite DOUBLE PRECISION DEFAULT NULL, id_transaction INT DEFAULT NULL, daty DATE NOT NULL, montanttotal DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
